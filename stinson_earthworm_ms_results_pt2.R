...
#Purpose: GLMs (ANOVAs) investigating the effects of site, eradication treatment,
#earthworm biomass, & treatment by earthworm biomass interaction on native plant diversity,
##Table 3
#Native plant diversity interaction plot (Figure 2)
#################################
#Figure 2/ANOVA Table 3- looking at treatment effects on earthworms
#read in csv file
